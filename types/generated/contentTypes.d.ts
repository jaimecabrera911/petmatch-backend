...
export interface ApiAdopterAdopter extends Schema.CollectionType {
  ...
  attributes: {
    dniType: Attribute.String;
    dniNumber: Attribute.String;
...
export interface ApiAdoptionApplicationAdoptionApplication
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    pet: Attribute.Relation<
      'api::adoption-application.adoption-application',
      'oneToOne',
      'api::pet.pet'
    >;
    adopter: Attribute.Relation<
      'api::adoption-application.adoption-application',
      'oneToOne',
      'api::adopter.adopter'
    >;
...
export interface ApiAdoptionCenterAdoptionCenter extends Schema.CollectionType {
  collectionName: 'adoption_centers';
  info: {
    singularName: 'adoption-center';
    pluralName: 'adoption-centers';
    displayName: 'AdoptionCenter';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::adoption-center.adoption-center',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::adoption-application.adoption-application': ApiAdoptionApplicationAdoptionApplication;
      'api::adoption-center.adoption-center': ApiAdoptionCenterAdoptionCenter;
